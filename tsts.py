...
class Simulation:
    ...
    def run(self,zone, connections,algo,end,t_list)->dict:
        ...
        while self.all_drones_at_goal():
            ...
            copy_zone_used = zone_used.copy()
            copy_connections_used = connections_used.copy()
            ...
            for drone in self.all_drones:
                ...
                if drone.state == "holding":
                        ...
                        current_count = copy_zone_used.get(next_zone, 0)

                        connection_count = copy_connections_used.get(connection_key, 0)
                        ...
                        if zone_t.metadata.get("zone") == "restricted":
                            ...
                            copy_connections_used[connection_key] = connection_count + 1
                        ...
                        copy_zone_used[next_zone]= current_count + 1
                        copy_connections_used[connection_key]= connection_count + 1
                    ...
                    current_count = copy_zone_used.get(next_z, 0)
                    max_drones = zone_t.metadata.get("max_drones", 1) 
                    ...
                    drone.path_index += 1
                    copy_zone_used[next_z]= current_count + 1
            ...
            zone_used = copy_zone_used
            connections_used = copy_connections_used   
